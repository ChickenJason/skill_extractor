...
from self_annotator.ask_qwen import validate_config  # noqa: E402
from self_annotator.parse_answers import (  # noqa: E402
    build_parse_summary,
    latest_raw_records,
    parse_raw_records,
)
from self_annotator.selection import (  # noqa: E402
    select_annotations,
    ...
    *, source_root: Path, run_id: str, config: dict[str, Any]
    ...
    try:
        ...
        write_selection_outputs(
            ...
            annotation_schema=config["annotation_schema"],
            consensus_schema=config["consensus_schema"],
            dataset_id=source_manifest.get("compatibility", {}).get(
                "dataset_id", f"sentence-dataset-{raw_sha_before[:16]}"
            ),
            source_sha256=source_manifest.get("compatibility", {}).get(
                "input_sha256", raw_sha_before
            ),
        )
